...
| ----: | -------: | -------------------------: | --------------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     1 |      12% |                        35% |                   4.2 | Core source and official packages are captured; the 18-row map, Ω geometry, color, Badge and per-tab presentation models pass all permanent gates. Installed original runtime capture, unified action adapter/coordinator and owner review remain open.               |

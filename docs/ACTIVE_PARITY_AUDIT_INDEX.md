...
| ----: | -------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     1 | Installation / startup / toolbar                         | `DELIVERY_ORDER_01_TOOLBAR_STATE.md` | `AUDIT_EVIDENCE_01_ORIGINAL_TOOLBAR.md`; `AUDIT_EVIDENCE_01_ORIGINAL_RELEASE.md`; `AUDIT_EVIDENCE_01C_ORIGINAL_CHROMIUM_RUNTIME.md`; `AUDIT_EVIDENCE_01D_ORIGINAL_FIREFOX_RUNTIME.md` | Original source, official packages and basic Chromium/Firefox runtime states captured; 18-row map complete; Ω geometry, color, Badge, pure per-tab presentation, isolated Action adapter and exact Canvas renderer implemented; advanced states and unified browser-action coordination remain absent | Capture remaining Fixed/Switch/PAC/Virtual/Rule List/temp/Inspect/external states, then compose the implemented renderer/Action adapter into one unified per-tab coordinator |

...
path = Path('apps/extension/src/entrypoints/options/AdvancedProfileEditor.svelte')
path.write_text("""<script lang=\"ts\">
  import {
    ...
    <section class=\"settings-section\">
      ...
      <label>
        ...
        <select
          ...
          {disabled}
          on:change={(event) =>
            updateFallback((event.currentTarget as HTMLSelectElement).value)}
        >
...
{/if}
""")
print('Reduced AdvancedProfileEditor to typed imported Auto Detect responsibility.')
